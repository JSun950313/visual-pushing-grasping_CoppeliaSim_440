...
This implementation requires the following dependencies (tested on Ubuntu 20.04.4 LTS): 

* Python 2.7 or Python 3 
* [NumPy](http://www.numpy.org/), [SciPy](https://www.scipy.org/scipylib/index.html), [OpenCV-Python](https://docs.opencv.org/3.0-beta/doc/py_tutorials/py_tutorials.html), [Matplotlib](https://matplotlib.org/), [Cbor](https://pypi.org/project/cbor/), [PyZMQ](https://github.com/zeromq/pyzmq). You can quickly install/update these dependencies by running the following (replace `pip` with `pip3` for Python 3):
  
  ```shell
  pip install numpy scipy opencv-python matplotlib cbor pyzmq
  ```
...
* Support [CoppeliaSim Ver 4.4.0](http://www.coppeliarobotics.com/) simulation environment
